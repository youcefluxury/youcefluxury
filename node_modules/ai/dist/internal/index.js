...
async function _retryWithExponentialBackoff(f, {
  ...
  try {
    ...
    if ((error instanceof Error && (import_provider6.APICallError.isInstance(error) && error.isRetryable === true || import_gateway.GatewayError.isInstance(error) && error.isRetryable === true) || (additionalRetryableError == null ? void 0 : additionalRetryableError(error)) === true) && tryNumber <= maxRetries) {
