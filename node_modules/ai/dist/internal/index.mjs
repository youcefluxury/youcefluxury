...
async function _retryWithExponentialBackoff(f, {
  ...
  try {
    ...
    if ((error instanceof Error && (APICallError.isInstance(error) && error.isRetryable === true || GatewayError.isInstance(error) && error.isRetryable === true) || (additionalRetryableError == null ? void 0 : additionalRetryableError(error)) === true) && tryNumber <= maxRetries) {
      await delay(
        getRetryDelayInMs({
          error,
