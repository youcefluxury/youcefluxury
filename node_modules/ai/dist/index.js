...
// src/version.ts
var VERSION = true ? "5.0.267" : "0.0.0-test";
...
function getOriginalUrl(originalData, convertedData) {
  return typeof originalData === "string" && convertedData instanceof URL && convertedData.toString() !== originalData ? originalData : void 0;
}
...
async function parseProviderExecutedDynamicToolCall(toolCall) {
  const parseResult = toolCall.input.trim() === "" ? { success: true, value: {} } : await (0, import_provider_utils9.safeParseJSON)({ text: toolCall.input });
...
function runToolsTransformation({
  ...
  const activeToolCallToolNames = /* @__PURE__ */ new Map();
    ...
    async transform(chunk, controller) {
      ...
      switch (chunkType) {
        ...
        case "tool-input-start": {
          ...
          await ((_b = (_a16 = tools == null ? void 0 : tools[chunk.toolName]) == null ? void 0 : _a16.onInputStart) == null ? void 0 : _b.call(_a16, {
            toolCallId: chunk.id,
            messages,
            abortSignal,
            experimental_context
        ...
        case "tool-input-delta": {
          ...
          if (toolName != null) {
            await ((_d = (_c = tools == null ? void 0 : tools[toolName]) == null ? void 0 : _c.onInputDelta) == null ? void 0 : _d.call(_c, {
        ...
        () => (
          ...
          recordSpan({
            ...
            fn: async (doEmbedSpan) => {
              ...
              if (embedding2 == null) {
                throw new import_provider17.InvalidResponseDataError({
...
async function safeValidateUIMessages({
  ...
  try {
    ...
    if (metadataSchema) {
      for (const message of validatedMessages) {
        message.metadata = await (0, import_provider_utils33.validateTypes)({
    ...
    if (dataSchemas) {
      for (const message of validatedMessages) {
        ...
        for (const dataPart of dataParts) {
          ...
          dataPart.data = await (0, import_provider_utils33.validateTypes)({
            value: dataPart.data,
            schema: dataSchema
          });
        }
