...
export default defineConfig({
  ...
  server: {
    ...
    port: 5173,
    /*
     * HMR stays OFF: the preview runs inside an iframe, and pushing React
     * refresh updates into it left the app mounted-but-empty (a blank white
     * page) until a manual reload. Every change is picked up by a normal page
     * load instead, so the preview can never end up in that half-updated
     * state.
     */
    hmr: false,
  },
